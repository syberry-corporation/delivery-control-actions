...
jobs:
  supervise:
    ...
    steps:
      ...
      - uses: syberry-corporation/delivery-control-actions/supervise-pr-gate@1.4.17
        with:
...
- uses: syberry-corporation/delivery-control-actions/supervise-build-gate@1.4.17
  with:
    supervisory_eval_url: ${{ vars.SUPERVISORY_EVAL_URL }}
    supervisory_project: davinci
    component: kernel
...
```yaml
- uses: syberry-corporation/delivery-control-actions/supervise-build-gate-artifact@1.4.17
  with:
...
deploy:
  ...
  permissions:
    ...
    id-token: write
  steps:
    - uses: syberry-corporation/delivery-control-actions/supervise-deploy-gate@1.4.17
      with:
        phase: pre
        supervisory_eval_url: ${{ vars.SUPERVISORY_EVAL_URL }}
        supervisory_project: davinci
